...
func (d *DB) loadPlayer(ctx context.Context, where string, arg any) (*game.Player, error) {
	q := `SELECT p.id, p.account_id, a.type as account_type, a.coins, a.coins_transferable, a.tournament_coins, p.group_id, p.name, p.level, p.vocation, p.sex,
	                  ...
	                  p.skill_critical_hit_chance, p.skill_critical_hit_chance_tries,
	                  p.skill_critical_hit_damage, p.skill_critical_hit_damage_tries,
	                  p.skill_life_leech_chance, p.skill_life_leech_chance_tries,
	                  p.skill_life_leech_amount, p.skill_life_leech_amount_tries,
	                  p.skill_mana_leech_chance, p.skill_mana_leech_chance_tries,
	                  p.skill_mana_leech_amount, p.skill_mana_leech_amount_tries,
	...
	err := d.SQL.QueryRowContext(ctx, q, arg).Scan(
		...
		&p.Skills[game.SkillCriticalHitChance], &p.SkillTries[game.SkillCriticalHitChance],
		&p.Skills[game.SkillCriticalHitDamage], &p.SkillTries[game.SkillCriticalHitDamage],
		&p.Skills[game.SkillLifeLeechChance], &p.SkillTries[game.SkillLifeLeechChance],
		&p.Skills[game.SkillLifeLeechAmount], &p.SkillTries[game.SkillLifeLeechAmount],
		&p.Skills[game.SkillManaLeechChance], &p.SkillTries[game.SkillManaLeechChance],
		&p.Skills[game.SkillManaLeechAmount], &p.SkillTries[game.SkillManaLeechAmount],
...
func (d *DB) SavePlayer(ctx context.Context, p *game.Player) error {
	const q = `UPDATE players SET
	              ...
	              skill_critical_hit_chance=?, skill_critical_hit_chance_tries=?,
	              skill_critical_hit_damage=?, skill_critical_hit_damage_tries=?,
	              skill_life_leech_chance=?, skill_life_leech_chance_tries=?,
	              skill_life_leech_amount=?, skill_life_leech_amount_tries=?,
	              skill_mana_leech_chance=?, skill_mana_leech_chance_tries=?,
	              skill_mana_leech_amount=?, skill_mana_leech_amount_tries=?,
