...
func registerSpellEnums(L *lua.LState) {
	enums := map[string]lua.LNumber{
		...
		// CallBackParam_t (creatures_definitions.hpp) is zero-based; these were all
		// one too high, and combat:setCallback switched on the shifted numbers.
		"CALLBACK_PARAM_LEVELMAGICVALUE": 0,
		"CALLBACK_PARAM_SKILLVALUE":      1,
		"CALLBACK_PARAM_TARGETTILE":      2,
		"CALLBACK_PARAM_TARGETCREATURE":  3,
		"CALLBACK_PARAM_CHAINVALUE":      4,
		"CALLBACK_PARAM_CHAINPICKER":     5,
		...
		// ConditionParam_t (from src/creatures/creatures_definitions.hpp)
