...
func (e *Engine) registerMonsterSpellClass() {
	...
	spellMethods := map[string]lua.LGFunction{
		...
		"setCombatEffect": func(L *lua.LState) int { return 0 },
		"castSound": func(L *lua.LState) int { return 0 },
		"impactSound": func(L *lua.LState) int { return 0 },
		"setCombatType": func(L *lua.LState) int { return 0 },
		"setConditionType": func(L *lua.LState) int { return 0 },
		...
		"setConditionDuration": func(L *lua.LState) int { return 0 },
		"setConditionSpeedChange": func(L *lua.LState) int { return 0 },
		"setNeedTarget": func(L *lua.LState) int { return 0 },
		"setCombatLength": func(L *lua.LState) int { return 0 },
		"setCombatSpread": func(L *lua.LState) int { return 0 },
		"setCombatRadius": func(L *lua.LState) int { return 0 },
		"setOutfitMonster": func(L *lua.LState) int { return 0 },
		"setOutfitItem": func(L *lua.LState) int { return 0 },
		"setConditionDamage": func(L *lua.LState) int { return 0 },
		"setCombatShootEffect": func(L *lua.LState) int { return 0 },
		"setConditionTickInterval": func(L *lua.LState) int { return 0 },
		"setScriptName": func(L *lua.LState) int { return 0 },
	}
